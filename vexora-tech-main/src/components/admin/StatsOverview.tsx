        ...
        {cards.map((card, i) => (
          ...
          >
            <div className="flex justify-between items-start mb-6">
              <div 
                className="w-12 h-12 rounded-xl flex items-center justify-center border border-white/5 relative group-hover:scale-110 transition-transform duration-500"
                style={{ backgroundColor: `${card.color}10`, color: card.color }}
              >
                <card.icon className="w-6 h-6 relative z-10" />
                <div className="absolute inset-0 blur-md opacity-0 group-hover:opacity-50 transition-opacity duration-500 rounded-xl" style={{ backgroundColor: card.color }} />
              </div>
              <div className="flex items-center gap-1 text-[10px] font-black text-secondary bg-secondary/10 px-2 py-1 rounded-full border border-secondary/20">
            ...
            {/* Ambient Back Glow */}
            <div className="absolute -right-4 -bottom-4 w-32 h-32 blur-[50px] opacity-20 group-hover:opacity-40 transition-opacity duration-700 rounded-full" style={{ backgroundColor: card.color }} />
          </motion.div>
        ))}
      </div>
